...
import com.example.adgroupassignment.AudioAdapter;
import com.example.adgroupassignment.AudioApplication;
import com.example.adgroupassignment.BroadcastActions;
...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void updateUI() {
        if (AudioApplication.getInstance().getServiceInterface().isPlaying()) {
            mBtnPlayPause.setImageResource(R.drawable.ic_baseline_pause);
        } else {
            mBtnPlayPause.setImageResource(R.drawable.ic_baseline_play);
        }
